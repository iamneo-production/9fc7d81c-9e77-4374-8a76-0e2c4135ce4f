...
(async () => {
  ...
  await page.goto('https://8080-ebccecdcffdeaddaddfcacbbbbfcabfbafe.examlyiopb.examly.io');
  ...
  await page1.goto('https://8081-ebccecdcffdeaddaddfcacbbbbfcabfbafe.examlyiopb.examly.io');
